...
Сценарий: 5. СПЗ. Ручной ввод (по плану потребности)
	...
	* Предмет договора и общие требования
		...
		И в поле 'Предмет договора' я ввожу текст 'Тест 1 ручное создание по плану потребности'
...
Сценарий: 6. СПЗ. Ручное создание (Вне плана потребности)
...
Сценарий: 7. СПЗ. Автоматическое создание (пакетный режим)

	* Помощник формирования программы закупок
...
Сценарий: 8. СПЗ. Автоматическое создание (рукчной режим)
