...
Сценарий: 1. СПЗ. Ручной ввод (по плану потребности)
...
Сценарий: 2. СПЗ. Ручное создание (вне плана потребности)
...
Сценарий: 3. СПЗ. Автоматическое создание (пакетный режим)
...
Сценарий: 4. СПЗ. Автоматическое создание (ручной режим)
		...
		И в поле с именем 'ПредметДоговора1' я ввожу текст 'Тест 2 ручной режим обработки'
