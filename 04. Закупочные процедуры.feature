...
Сценарий: 04.0. Приказ о назначении закупочной комиссии
...
Сценарий: 04.1. ЗП1 [лотовая]-[Товар1]-[По критериям]
	...
	* Создание
		...
		И в таблице "Список" я перехожу к строке:
			...
			| 'RUB'              | 'Королевство Севера [223]' | 'Королевство Севера [223]' | '2023 г.'        | 'ТЕСТ1 [ПО ПЛАНУ]-[Товар1]' | 'Утвержден' | 'Запрос предложений' | 'Утвержден' | '400 000,00'      |
...
Сценарий: 04.2. ЗП2 [лотовая]-[Товар1]-[По ценам]
	...
	* Создание
		...
		И в таблице "Список" я перехожу к строке:
			| 'Валюта документа' | 'Заказчик'                 | 'Организатор закупки'      | 'Период закупок' | 'Предмет договора'           | 'Состояние' | 'Способ закупки'     | 'Статус'    | 'Сумма документа' |
			| 'RUB'              | 'Королевство Севера [223]' | 'Королевство Севера [223]' | '2023 г.'        | 'ТЕСТ2 [ВНЕ ПЛАНА]-[Товар1]' | 'Утвержден' | 'Запрос предложений' | 'Утвержден' | '15 000,00'       |
...
Сценарий: 04.3. ЗП3 [Попозиционная]-[Материал1,2,3]-[По ценам]
	...
	* Создание
		...
		И в таблице "Список" я перехожу к строке:
			| 'Валюта документа' | 'Заказчик'                 | 'Организатор закупки'      | 'Период закупок' | 'Предмет договора'                                   | 'Состояние' | 'Способ закупки'     | 'Статус'    | 'Сумма документа' |
			| 'RUB'              | 'Королевство Севера [223]' | 'Королевство Севера [223]' | '2023 г.'        | 'ТЕСТ3 [ОБРАБОТКА - ПАКЕТНЫЙ РЕЖИМ]-[Материал1,2,3]' | 'Утвержден' | 'Запрос предложений' | 'Утвержден' | '1 237 200,00'    |
...
Сценарий: 04.4. ЗП4 [Зонтичная закупка]-[Товар2]-[По ценам]
	...
	* Создание
		...
		И в таблице "Список" я перехожу к строке:
			| 'Валюта документа' | 'Заказчик'                 | 'Организатор закупки'      | 'Период закупок' | 'Предмет договора'                          | 'Состояние' | 'Способ закупки'     | 'Статус'    | 'Сумма документа' |
			| 'RUB'              | 'Королевство Севера [223]' | 'Королевство Севера [223]' | '2023 г.'        | 'ТЕСТ4 [ОБРАБОТКА - РУЧНОЙ РЕЖИМ]-[Товар2]' | 'Утвержден' | 'Запрос предложений' | 'Утвержден' | '64 000,00'       |
	...
	* Наименование процедуры
		...
		И в поле с именем 'Наименование' я ввожу текст 'ЗП4'
	...
	* Лоты
		...
		И в поле 'Количество победителей' я ввожу текст '2'
		И я перехожу к следующему реквизиту
		И я устанавливаю флаг 'Запрет превышения НМЦ'
		И я нажимаю на кнопку 'Записать и закрыть'
		И я жду закрытия окна 'Лот: Лот №1 *' в течение 20 секунд
	...
	* Предложения участника 1	
		...
		И в таблице "УсловияПоНоменклатуреПоПериодам" я активизирую поле с именем "УсловияПоНоменклатуреПоПериодамЦена"
		И в таблице "УсловияПоНоменклатуреПоПериодам" в поле с именем 'УсловияПоНоменклатуреПоПериодамЦена' я ввожу текст '300,00'
		И в таблице "УсловияПоНоменклатуреПоПериодам" я завершаю редактирование строки
	...
	* Предложения участника 2
		...
		И в таблице "УсловияПоНоменклатуреПоПериодам" я активизирую поле с именем "УсловияПоНоменклатуреПоПериодамЦена"
		И в таблице "УсловияПоНоменклатуреПоПериодам" в поле с именем 'УсловияПоНоменклатуреПоПериодамЦена' я ввожу текст '350,00'
		И в таблице "УсловияПоНоменклатуреПоПериодам" я завершаю редактирование строки
	...
	* Предложения участника 3
		...
		И в таблице "УсловияПоНоменклатуреПоПериодам" я активизирую поле с именем "УсловияПоНоменклатуреПоПериодамЦена"
		И в таблице "УсловияПоНоменклатуреПоПериодам" в поле с именем 'УсловияПоНоменклатуреПоПериодамЦена' я ввожу текст '330,00'
		И в таблице "УсловияПоНоменклатуреПоПериодам" я завершаю редактирование строки
	...
	* Оценка предложений и выбор победителя
		...
		И в таблице "ПредложенияПобедителей" я нажимаю на кнопку 'Зафиксировать победителей по зонтичной закупке'
		И Пауза 2
